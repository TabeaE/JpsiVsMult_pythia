...
/**
 * 
 * This macro contains the information what exactly the plotRelOrigin macro should plot.
 * 
 ...
 *  - variationsName: the same, e.g. pT The output name will be something like ...inclusive_pT.pdf, for
 *    inclusive J/psi in pT bins
  ...
  vector<Variation>*variations_ptr = 0x0) {
    ...
    switch(plotWhat) {
      ...
      case 2: {
        ...
        variations.push_back(Variation("4 GeV/#it{c} < #it{p}_{T} < 8 GeV/#it{c}",
                                       "onium.pt>4 && onium.pt<8", kRed, 21));
      ...
      case 4: {
        ...
        variations.push_back(Variation("other decay channels",    "!dilepton",   kGreen+2, 24));
        variations.push_back(Variation("dielectron decay channel", "dielectron", kBlue,  22));
        break;}
